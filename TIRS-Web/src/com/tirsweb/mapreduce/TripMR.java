...
public class TripMR extends Configured implements Tool {
	...
	public static class MyMapper extends Mapper<Object, Text, NullWritable, Text> {
		...
		public void map(Object key, Text value, Context context)
			...
			context.write(nw, new Text(strs[1]));
		}
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(TripMR.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new TripMR(), args);
		System.exit(res);
	}
}
