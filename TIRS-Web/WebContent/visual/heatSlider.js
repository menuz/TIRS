var HeatSlider = function(canvas,rootElement){
	...
	this.rangemax=50;
	this.values=[0,50];
	this.priceInterval=1;
	this.leastMinMaxInterval=5;
	this.priceIndicator=this.values[0]-1;  
	this.originValues= [0,50];//the value of last time 
	...
	this.houseImg.onload=function(){
	}
	this.houseImg.src = "images/rent05.png";		
}		
