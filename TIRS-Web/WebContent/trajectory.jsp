...
<script type="text/javascript">
	...
	function query2() {
		...
		self.parent.frames["map"].query2(content);
	}
	
	function arc_query() {
		self.parent.frames["map"].arc_query();
	}
	
	function arc_play() {
		self.parent.frames["map"].arc_arc_play();
	}
	
	function arc_node_play() {
		self.parent.frames["map"].arc_node_play();
	}
...
<body>
	...
	<table>
		<tr>
			<td width="50%"><input type="text" id="content" value="freetrip+20111201231249+20999+1" size="10"></td>  
		</tr>
		
		<tr>
			<td width="50%"><input type="button" value="Query"
				onclick="query2()" class="btn" /></td>
		</tr>
	</table>
	
		<table>		
		<tr>
			<td width="50%"><input type="button" value="Arc_Query"
				onclick="arc_query()" class="btn" /></td>
		</tr>
		<tr>
			<td>
				query all arc info from db
			</td>
		</tr>
		
		<tr>
			<td width="50%"><input type="button" value="display_arc"
				onclick="arc_play()" class="btn" /></td>
		</tr>
		<tr>
			<td>
				iterate arc list and request google direction api and push data to db
			</td>
		</tr>
		
		<tr>
			<td width="50%"><input type="button" value="display_node"
				onclick="arc_node_play()" class="btn" /></td>
		</tr>
		<tr>
			<td>
				iterate arc list and display line between arc_head/tail 
			</td>
		</tr>
	...
	<table>		
		<tr>
			<td width="50%">
				<input type="text" id="boxid" value="boxid" size="10">
			</td>  
		</tr>
		<tr>
			<td width="50%"><input type="button" value="Box"
				onclick="box()" class="btn" /></td>
		</tr>
		<tr>
			<td>
